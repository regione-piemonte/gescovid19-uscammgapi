...
public interface AnagrafeSanitariaSoap {
    ...
    @RequestWrapper(localName = "GetProfiloSanitario", targetNamespace = "http://AnagrafeSanitaria.central.services.auraws.aura.csi.it", className = "it.csi.gescovid.uscammgapi.business.aura.get.GetProfiloSanitario")
    @ResponseWrapper(localName = "GetProfiloSanitarioResponse", targetNamespace = "http://AnagrafeSanitaria.central.services.auraws.aura.csi.it", className = "it.csi.gescovid.uscammgapi.business.aura.get.GetProfiloSanitarioResponse")
