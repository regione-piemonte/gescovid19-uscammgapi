...
@Path("/consensi-farmaci")
@Api(value = "consensi-farmaci", produces = MediaType.APPLICATION_JSON)
@ApiResponsesDefault
public interface ConsensiFarmaciApi  {
    ...
    @ApiResponses(value = { 
    		@ApiResponse(code = 200, message = "Success", response = ModelConsensoFarmaco.class,responseContainer = "List")
    })

    public Response consensiFarmaciGet(
    		...
    		@QueryParam("soggetto") Integer soggetto, @QueryParam("farmaco") Integer farmaco, @QueryParam("tipo") Integer tipo,@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders , @Context HttpServletRequest httpRequest );
}
