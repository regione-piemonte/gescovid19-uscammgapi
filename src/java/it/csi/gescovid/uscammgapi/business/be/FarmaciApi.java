...
@Path("/farmaci")
@Api(value = "farmaci", produces = MediaType.APPLICATION_JSON)
@ApiResponsesDefault
public interface FarmaciApi  {
   
    @GET
    @Produces({ "application/json" })
    @ApiResponses(value = { 
    		@ApiResponse(code = 200, message = "Success", response = ModelFarmaco.class, responseContainer = "List")
    })
    public Response farmaciGet(
