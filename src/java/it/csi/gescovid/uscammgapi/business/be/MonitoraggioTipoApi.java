...
@Path("/monitoraggio-tipi")
@Api(value = "monitoraggio-tipi", produces = MediaType.APPLICATION_JSON)
@ApiResponsesDefault
public interface MonitoraggioTipoApi  {
   
    @GET
    @Produces({ "application/json" })
    @ApiResponses(value = { 
    		@ApiResponse(code = 200, message = "Success", response = ModelMonitoraggioTipo.class, responseContainer = "List")
    })
    public Response monitoraggioTipiGet(
