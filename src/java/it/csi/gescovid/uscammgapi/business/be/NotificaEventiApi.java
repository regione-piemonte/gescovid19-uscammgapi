...
@Path("/notifica-eventi")
@Api(value = "notifica-eventi", produces = MediaType.APPLICATION_JSON)
@ApiResponsesDefault
public interface NotificaEventiApi {

    @GET
    @Produces({ "application/json" })
    @ApiResponses(value = { 
    		@ApiResponse(code = 200, message = "Success", response = ModelNotificaEvento.class, responseContainer = "List")
    })
    public Response notificaEventiGet(
