...
@Path("/notifica-priorita")
@Api(value = "notifica-priorita", produces = MediaType.APPLICATION_JSON)
@ApiResponsesDefault
public interface NotificaPrioritaApi {

    @GET
    @Produces({ "application/json" })
    @ApiResponses(value = { 
    		@ApiResponse(code = 200, message = "Success", response = ModelNotificaPriorita.class, responseContainer = "List")
    })
    public Response notificaPrioritaGet(
