...
@Path("/notifica-tipi")
@Api(value = "notifica-tipi", produces = MediaType.APPLICATION_JSON)
@ApiResponsesDefault
public interface NotificaTipiApi  {
   
    @GET
    @Produces({ "application/json" })
    @ApiResponses(value = { 
    		@ApiResponse(code = 200, message = "Success", response = ModelNotificaTipo.class, responseContainer = "List")
    })
    public Response notificaTipiGet(
