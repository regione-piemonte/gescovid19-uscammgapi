...
@Path("/ossigenoterapie")
@Api(value = "ossigenoterapie", produces = MediaType.APPLICATION_JSON)
@ApiResponsesDefault 
public interface OssigenoterapieApi  {
   
    @GET
    @Produces({ "application/json" })
    @ApiResponses(value = { 
    		@ApiResponse(code = 200, message = "Success", response = ModelOssigenoterapia.class, responseContainer = "List")
    })
    public Response ossigenoterapieGet(
