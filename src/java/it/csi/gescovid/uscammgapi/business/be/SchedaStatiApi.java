...
@Path("/scheda-stati")
@Api(value = "scheda-stati", produces = MediaType.APPLICATION_JSON)
@ApiResponsesDefault
public interface SchedaStatiApi  {
   
    @GET    
    @Produces({ "application/json" })
    @ApiResponses(value = { 
    		@ApiResponse(code = 200, message = "Success", response = ModelSchedaStato.class, responseContainer = "List")
    })
    public Response schedaStatiGet(
