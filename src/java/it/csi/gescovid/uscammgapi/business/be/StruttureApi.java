...
@Path("/strutture")
@Api(value = "Strutture", produces = MediaType.APPLICATION_JSON)
@ApiResponsesDefault
public interface StruttureApi  {
    ...
    @ApiResponses(value = { 
    		@ApiResponse(code = 200, message = "Success", response = ModelStruttura.class, responseContainer = "List")
    })
    public Response struttureUscaGet(
