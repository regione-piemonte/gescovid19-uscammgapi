...
public interface BaseMedicoMapper {
	 ...
	 * @mbg.generated
	 */
	@Select({ "select", "id_medico, cf_medico, codice_reg, cognome, nome, sostituito_da, sostituisce", "from medico",
	...
	@Update({ "update medico", "set cf_medico = #{cfMedico,jdbcType=VARCHAR},",
			...
			"nome = #{nome,jdbcType=VARCHAR},", "sostituito_da = #{sostituitoDa,jdbcType=VARCHAR},",
			"sostituisce = #{sostituisce,jdbcType=VARCHAR}", "where id_medico = #{idMedico,jdbcType=BIGINT}" })
