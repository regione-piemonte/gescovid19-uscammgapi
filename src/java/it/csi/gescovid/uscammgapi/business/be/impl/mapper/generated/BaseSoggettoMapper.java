...
public interface BaseSoggettoMapper {
	...
	@Insert({ "insert into soggetto (codice_fiscale, id_asr, ", "cognome, nome, data_nascita_str, ",
			...
			"data_nascita, asl_residenza, ", "asl_domicilio, email, ", "id_tipo_soggetto)",
			...
			"#{aslDomicilio,jdbcType=VARCHAR}, #{email,jdbcType=VARCHAR}, ", "#{idTipoSoggetto,jdbcType=INTEGER})" })
	...
	@Select({ "select",
			...
			"asl_residenza, asl_domicilio, email, id_tipo_soggetto", "from soggetto",
