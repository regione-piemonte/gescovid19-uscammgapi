package it.csi.gescovid.uscammgapi.filter;

import it.csi.gescovid.uscammgapi.business.*;
import it.csi.gescovid.uscammgapi.util.*;
		...
		if (hreq.getSession().getAttribute(IRIDE_ID_SESSIONATTR) == null) {
			...
			if (marker != null) {
				try {
					...
					it.csi.gescovid.uscammgapi.dto.test.UserInfo userInfo = new it.csi.gescovid.uscammgapi.dto.test.UserInfo();
